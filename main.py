...
@app.route('/promotion')
def promortion():
    ls = ['Человечество вырастает из детства.',
    ...
    return f"""<!doctype html>
                <html lang="en">
                  <head>
                    ...
                    <link rel="stylesheet" type="text/css" href="{url_for('static', filename='css/mystules.css')}"
        ...
        return f'''<!doctype html>
                        <html lang="en">
                          ...
                          <body>
                            ...
                            <h1><p align="center">на участие в мисии</p></h1>
                            <div>
                                <form class="login_form" method="post">
                                    ...
                                    <br>
                                    <br>
                                    <input type="gmail" class="form-control" id="gmail" placeholder="Введите адрес почты" name="password">
                                    ...
                                    <div class="form-group1">
                                        <label for="form-check">Укажите пол</label>
                                        <div class="form-check">
                                          <input class="form-check-input" type="radio" name="sexx" id="male" value="male" checked>
                                          <label class="form-check-label" for="male">
                                            Мужской
                                          </label>
                                        </div>
                                        <div class="form-check1">
                                          <input class="form-check-input" type="radio" name="sexx" id="female" value="female">
                                          <label class="form-check-label" for="female">
                                            Женский
                                          </label>
                                        </div>
